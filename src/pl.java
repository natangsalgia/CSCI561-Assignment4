...
public class pl {
    ...
    public static void main(String[] args) {
        ...
        final int task = 1;
        final String kb = "examples/1/kb1.txt";
        final String q = "examples/1/q1.txt";
        final String oe = "output/op1_q1.txt";
        final String ol = "output/ol1_q1.txt";
        
/*        final int task = 2;
        final String kb = "examples/2/kb2.txt";
        final String q = "examples/2/q2.txt";
        final String oe = "output/op2_q2.txt";
        final String ol = "output/ol2_q2.txt";
*/
